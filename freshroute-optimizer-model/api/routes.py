...
def forecast_demand_get(
    ...
    if district_id:
        ...
        return [
            ForecastResponse(
                ...
                forecast_demand_lower_lbs=one.get("forecast_demand_lower_lbs"),
                forecast_demand_upper_lbs=one.get("forecast_demand_upper_lbs"),
    ...
    return [
        ForecastResponse(
            ...
            forecast_demand_lower_lbs=b.get("forecast_demand_lower_lbs"),
            forecast_demand_upper_lbs=b.get("forecast_demand_upper_lbs"),
